...
RUN apt-get install --no-install-recommends --no-install-suggests -yqq build-essential openssl libxml2-dev libncurses5-dev uuid-dev sqlite3 libsqlite3-dev pkg-config curl libjansson-dev libgtk2.0-dev
